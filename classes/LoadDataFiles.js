...
LoadDataFiles.URL_CONSTELLATION = "http://localhost/proxy2.php?url=http://en.wikipedia.org/wiki/List_of_stars_in_Orion";//"http://en.wikipedia.org/wiki/List_of_stars_in_Gemini";//"http://en.wikipedia.org/wiki/List_of_stars_in_Vulpecula";//"http://en.wikipedia.org/wiki/List_of_stars_in_Andromeda";//"http://en.wikipedia.org/wiki/List_of_stars_in_Scorpius";//
...
function LoadDataFiles(){
	...
	this.wikipediaUrls = StringOperators.splitString(constNames, ",").append("http://localhost/proxy2.php?url=http://en.wikipedia.org/wiki/List_of_stars_in_", false);
