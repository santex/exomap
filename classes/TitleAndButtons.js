function TitleAndButtons(){
	this.titletext = 'sky views'; //+VIEW.n;
...
TitleAndButtons.prototype.draw = function(){
	DrawTexts.setContextTextProperties(this.titleColor, 16, 'Times', null, null, 'italic');
	...
	DrawTexts.setContextTextProperties(this.strongColor, 14, 'Times');
	...
	this.textBoxBelow.x = canvasWidth - this.textBoxBelow.maxWidth - 5;
	this.textBoxBelow.y = canvasHeight-18;
